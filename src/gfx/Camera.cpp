...
void Camera::Update() {
    ...
    if (Input::IsKeyPressed(SDL_SCANCODE_W)) m_Position += frontXZ * velocity;
    if (Input::IsKeyPressed(SDL_SCANCODE_S)) m_Position -= frontXZ * velocity;
    if (Input::IsKeyPressed(SDL_SCANCODE_A)) m_Position -= rightXZ * velocity;
    if (Input::IsKeyPressed(SDL_SCANCODE_D)) m_Position += rightXZ * velocity;
    if (Input::IsKeyPressed(SDL_SCANCODE_SPACE)) m_Position += glm::vec3(0.0f, 1.0f, 0.0f) * velocity;
    if (Input::IsKeyPressed(SDL_SCANCODE_LSHIFT)) m_Position -= glm::vec3(0.0f, 1.0f, 0.0f) * velocity;
}
